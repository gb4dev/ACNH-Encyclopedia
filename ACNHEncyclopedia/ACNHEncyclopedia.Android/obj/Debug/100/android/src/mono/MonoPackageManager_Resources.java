...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ACNHEncyclopedia.Android.dll" comes first in this list. */
		"ACNHEncyclopedia.Android.dll",
		"ACNHEncyclopedia.dll",
		"DLToolkit.Forms.Controls.FlowListView.dll",
		"DotNetZip.dll",
		"DryIoc.dll",
		"FormsViewGroup.dll",
		"Google.Android.Vending.Expansion.Downloader.dll",
		"Google.Android.Vending.Expansion.ZipFile.dll",
		"Google.Android.Vending.Licensing.dll",
